#!/usr/bin/env bash
# ==============================================================================
# COSMOS 3 EDGE: ONLINE VIDEO EXTRACTION WITH ZERO AUGMENTATION (CLEAN V1, SEED 42)
# Strictly unaugmented baseline to compare fairly with the augmented runs.
# ==============================================================================
set -Eeuo pipefail
...
LOG_FILE="outputs/logs/c3_online_unaugmented_v1_$(date +%Y%m%d_%H%M%S).log"
exec > >(tee -a "$LOG_FILE") 2>&1

OUTPUT_DIR="outputs/train/v1-cosmos3-edge-lora-online-unaugmented-smolexpert"
...
echo "================================================================================"
echo "LAUNCHING COSMOS 3 EDGE ONLINE UNAUGMENTED V1 TRAINING (SEED 42) AT $(date)"
echo "Output directory: $OUTPUT_DIR"
echo "LoRA weights:     $LORA_WEIGHTS"
echo "Augmentation:     NONE (Clean unaugmented frames)"
echo "Seed:             42"
...
echo "================================================================================"
echo "COSMOS 3 EDGE ONLINE UNAUGMENTED V1 TRAINING (SEED 42) COMPLETED AT $(date)"
echo "================================================================================"
