#!/usr/bin/env bash
# ==============================================================================
# COSMOS 3 EDGE: ONLINE VIDEO EXTRACTION WITH PHOTOMETRIC-ONLY AUGMENTATION (CLEAN V1)
# Leaves out spatial translations and crops to preserve camera-world coordinate geometry.
# ==============================================================================
set -Eeuo pipefail
...
LOG_FILE="outputs/logs/c3_online_photometric_v1_$(date +%Y%m%d_%H%M%S).log"
exec > >(tee -a "$LOG_FILE") 2>&1

OUTPUT_DIR="outputs/train/v1-cosmos3-edge-lora-online-photometric-smolexpert"
...
echo "================================================================================"
echo "LAUNCHING COSMOS 3 EDGE ONLINE PHOTOMETRIC-ONLY V1 TRAINING AT $(date)"
echo "Output directory: $OUTPUT_DIR"
echo "LoRA weights:     $LORA_WEIGHTS"
echo "Augmentation:     Photometric jitter (brightness, contrast, sat, hue) + blur (NO spatial crop)"
...
echo "================================================================================"
echo "COSMOS 3 EDGE ONLINE PHOTOMETRIC-ONLY V1 TRAINING COMPLETED AT $(date)"
echo "================================================================================"
